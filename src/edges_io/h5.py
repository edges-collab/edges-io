...
class HDF5RawSpectrum(HDF5Object):
    ...
    _structure = {
        "meta": {
            ...
            "start": "optional",  # utils.isintish,
            "stop": "optional",  # utils.isintish,
            "site": "optional",  # utils.isstringish,
            "instrument": "optional",  # utils.isstringish,
            "switch_delay": "optional",  # utils.isfloatish,
            "input_channel": "optional",  # utils.isintish,
            "voltage_range": "optional",  # utils.isnumeric,
            "samples_per_accumulation": "optional",  # utils.isintish,
            "acquisition_rate": "optional",  # utils.isnumeric,
            "num_channels": "optional",  # utils.isintish,
            "num_taps": "optional",  # utils.isintish,
            "window_function_id": "optional",  # utils.isintish,
            "num_fft_threads": "optional",  # utils.isintish,
            "num_fft_buffers": "optional",  # utils.isintish,
            "stop_cycles": "optional",  # utils.isintish,
            "stop_seconds": "optional",  # utils.isfloatish,
            "stop_time": "optional",
